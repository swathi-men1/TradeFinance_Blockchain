...
export default function BankDashboard() {
    ...
    if (loading) return <div className="text-white">Loading Bank Dashboard...</div>;
    ...
    return (
        <div className="space-y-8 fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* 2. Status Breakdown */}
                <GlassCard>
                    <h3 className="text-xl font-bold text-white mb-4">Trade Status Breakdown</h3>
                ...
                <GlassCard>
                    <h3 className="text-xl font-bold text-white mb-4">Lifecycle Event Control</h3>
