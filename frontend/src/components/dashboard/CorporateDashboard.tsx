...
import { DollarSign, Briefcase, FileText, Shield, Upload, Eye, RefreshCw } from 'lucide-react';
...
export default function CorporateDashboard() {
    ...
    if (loading) return <div className="text-content-primary">Loading Corporate Dashboard...</div>;
    ...
    return (
        <div className="space-y-5 fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <ElevatedPanel>
                    <h3 className="text-xl font-bold text-content-primary mb-4">Participation Summary</h3>
                    <div className="space-y-4">
                        <div className="flex justify-between items-center p-3 bg-white/5 rounded-lg">
                            <span className="text-gray-300">As Buyer</span>
                            <span className="text-xl font-bold text-content-primary">{analytics.participation.as_buyer}</span>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-white/5 rounded-lg">
                            <span className="text-gray-300">As Seller</span>
                            <span className="text-xl font-bold text-content-primary">{analytics.participation.as_seller}</span>
                        </div>
                ...
                <div className="space-y-6">
                    <Link to="/upload" className="block group">
                        <ElevatedPanel className="h-full flex flex-col justify-center items-center text-center p-5 hover:bg-white/10 transition-colors">
                            <div className="text-5xl mb-4 text-primary"><Upload className="w-12 h-12" /></div>
                            <h3 className="text-2xl font-bold text-content-primary mb-2">Submit Trade Document</h3>
                    ...
                    <Link to="/trades" className="block group">
                        <ElevatedPanel className="h-full flex flex-col justify-center items-center text-center p-5 hover:bg-white/10 transition-colors">
                            <div className="text-5xl mb-4 text-primary"><Eye className="w-12 h-12" /></div>
                            <h3 className="text-2xl font-bold text-content-primary mb-2">Track Transactions</h3>
            ...
            <ElevatedPanel>
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-bold text-content-primary">Alerts & Notifications</h3>
                ...
                <div className="space-y-4 max-h-[300px] overflow-y-auto custom-scrollbar">
                    ...
                    {analytics.documents.total_submitted > 0 && (
                        <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border-l-4 border-lime transition-all hover:bg-white/10">
                            ...
                            <div>
                                <p className="text-content-primary font-semibold">Document Submission Update</p>
                    ...
                    {analytics.status_summary.active > 0 && (
                        <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border-l-4 border-blue-500 transition-all hover:bg-white/10">
                            <span className="text-2xl"><RefreshCw className="w-6 h-6" /></span>
                            <div>
                                <p className="text-content-primary font-semibold">Transaction Status Update</p>
                    ...
                    {riskScore && (
                        <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border-l-4 border-purple-500 transition-all hover:bg-white/10">
                            <span className="text-2xl"><Shield className="w-6 h-6" /></span>
                            <div>
                                <p className="text-content-primary font-semibold">Risk Level Monitoring</p>
            ...
            {riskScore && (
                <ElevatedPanel>
                    <h3 className="text-xl font-bold text-content-primary mb-4">Risk Insight</h3>
                    <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h4 className="text-lg font-bold text-content-primary">Your Risk Profile</h4>
                                <p className="text-sm text-gray-400">Category: <span className="font-bold text-content-primary">{riskScore.category}</span></p>
                            </div>
                            <div className="text-2xl font-bold text-blue-400">{riskScore.score}</div>
                        </div>
