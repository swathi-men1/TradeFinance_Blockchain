...
export default function BankDashboardPage() {
  ...
  return (
    <div className="fade-in space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-3">
              <span className="role-badge role-bank">BANK</span>
      ...
      {/* Status Breakdown */}
      <GlassCard>
        <h3 className="text-xl font-bold text-white mb-4">Transaction Status Breakdown</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Object.entries(analytics?.status_breakdown || {}).map(([status, count]) => (
            <div key={status} className="bg-dark/50 rounded-xl p-4 text-center">
              <div className={`text-3xl font-bold ${getStatusColor(status)}`}>{count}</div>
